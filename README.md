...
> 当前状态：v2.3.8 已完成源码回归、Windows/Android 构建、启动验收和 Release 资产回读；本版本只提供 Windows、Android 和 Windows 上需要的辅助工具。许可证：[Apache-2.0](LICENSE) · 作者：xuan

当前正式发布：[v2.3.8](https://github.com/xuange6610/SyncWatch/releases/tag/v2.3.8)，已发布并设为 Latest；[v2.3.8 发布说明](docs/release-notes-v2.3.8.md)记录本轮修复范围。
