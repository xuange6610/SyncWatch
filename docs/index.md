...
| Release、文件地图和贡献 | [v2.2.5 发布说明](release-notes-v2.2.5.md)、[v2.2.3 发布说明](release-notes-v2.2.3.md)、[发布文件说明](release-artifacts.md)、[仓库文件地图](repository-map.md)、[参与贡献](contributing.html)、[CONTRIBUTING.md](../CONTRIBUTING.md) |
...
- 当前正式版本为 [v2.2.4](https://github.com/xuange6610/SyncWatch/releases/tag/v2.2.4)，已设为 Latest；`v2.2.5` 正在候选分支等待完整构建。正式下载以 GitHub Release API 实际资产为准。
