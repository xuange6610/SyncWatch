...
- 当前线上正式版本：`v2.2.3`；2026-08-27 复核时远端 `main` 与 `v2.2.3` 指向提交 `51f8c6941614b6c7a1e31800df62115018d2468f`。本地唯一发布工作分支 `release/v2.2.4` 正在准备下一版本；只有最终 PR、annotated Tag、原子工作流和 26+2 资产完成后才能把本项改为 v2.2.4。
- 当前仓库：`https://github.com/xuange6610/SyncWatch`。
- 当前 Pages：`https://xuange6610.github.io/SyncWatch/`。
- v2.1.7、v2.1.8、v2.1.9、v2.2.0 与 v2.2.3 均已验证为 26 个维护者资产，加 2 个 GitHub 源码归档，每个版本共 28 个可见文件；v2.2.3 已设为 Latest，后续正式版本继续沿用同一门禁。
