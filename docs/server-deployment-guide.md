...
适用版本：v2.4.2 候选版（文档更新于 2026-09-04；本地构建已完成，正式资产待维护者确认后上传）

本文面向需要把 SyncWatch同步观影 放到 Windows Server、Linux 云服务器、Docker 或内网穿透环境长期运行的用户。文中的 `vX.Y.Z` 表示实际部署版本；v2.4.2 候选的文件名、大小和 SHA-256 已在本地 `dist/` 核验，上传后再以 GitHub Release 页面为准。
