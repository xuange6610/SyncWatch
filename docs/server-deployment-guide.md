...
适用版本：v2.3.5 候选版（文档更新于 2026-09-02；正式资产以 Release API 与下载回读为准）

本文面向需要把 SyncWatch同步观影 放到 Windows Server、Linux 云服务器、Docker 或内网穿透环境长期运行的用户。文中的 `vX.Y.Z` 表示实际部署版本；v2.3.5 正在完成正式资产验收，文件名、大小和 SHA-256 以 GitHub Release 页面为准。
