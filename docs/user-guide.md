...
- 顶栏“生成 APK”会下载本 EXE 内置并经过签名校验的 `SyncWatch-Android-v2.2.4-universal.apk`。安装后输入服务器地址即可使用与网页端一致的房间、播放、聊天、上传、全屏和账户功能；普通客户端不显示服务器 LAN IP，公网分享只使用可信 HTTPS/Tunnel 地址。
