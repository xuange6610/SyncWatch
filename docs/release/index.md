...
- [v2.2.4 候选发布说明（26+2 门禁通过前尚未发布）](../release-notes-v2.2.4.md)
- [v2.2.3 发布说明（上一正式版）](../release-notes-v2.2.3.md)
...
发布前检查版本号、Git tag、平台/架构、文件大小和成品契约测试；根目录 `dist/` 是唯一正式成品目录，临时资源只允许放在 `.build/`。
