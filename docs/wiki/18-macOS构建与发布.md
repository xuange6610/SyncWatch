...
- `SyncWatch-Server-macOS-v2.2.4-x64.dmg` / `.zip`
- `SyncWatch-Server-macOS-v2.2.4-arm64.dmg` / `.zip`
- `SyncWatch-Client-macOS-v2.2.4-x64.dmg` / `.zip`
- `SyncWatch-Client-macOS-v2.2.4-arm64.dmg` / `.zip`
- `SyncWatch-Full-Offline-macOS-v2.2.4-x64.dmg` / `.zip`
- `SyncWatch-Full-Offline-macOS-v2.2.4-arm64.dmg` / `.zip`
