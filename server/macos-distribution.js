...
function releaseVersion(value) {
  const normalized = String(value || '2.2.4').trim().replace(/^v/i, '');
  return /^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/.test(normalized) ? normalized : '2.2.4';
}

function macArtifactFilename(kind, architecture, format, version = '2.2.4') {
...
function createMacDistribution({
  kind, version = '2.2.4', legacyPaths = {}, configured = {}, roots = [],
