...
function releaseVersion(value) {
  const normalized = String(value || '2.2.5').trim().replace(/^v/i, '');
  return /^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/.test(normalized) ? normalized : '2.2.5';
}

function macArtifactFilename(kind, architecture, format, version = '2.2.5') {
...
function createMacDistribution({
  kind, version = '2.2.5', legacyPaths = {}, configured = {}, roots = [],
