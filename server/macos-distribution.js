...
function releaseVersion(value) {
  const normalized = String(value || '2.2.1').trim().replace(/^v/i, '');
  return /^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/.test(normalized) ? normalized : '2.2.1';
}

function macArtifactFilename(kind, architecture, format, version = '2.2.1') {
...
function createMacDistribution({
  kind, version = '2.2.1', legacyPaths = {}, configured = {}, roots = [],
