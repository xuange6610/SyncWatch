...
for (const filename of [
  'SyncWatch-Experience-Client-Portable-v2.2.8-x64.exe',
  'SyncWatch-Standard-Server-Portable-v2.2.8-x64.exe',
  'SyncWatch-v2.2.8-Full-Offline-Installer-x64.exe',
  'SyncWatch-v2.2.8-Full-Offline-Portable-x64.exe',
  'SyncWatch-Android-v2.2.8-universal.apk',
...
assert.equal((html.match(/class="download-role-badge download-role-client"/g) || []).length, 2,
  '下载中心必须明确标注客户端文件');
assert.equal((html.match(/class="download-role-badge download-role-server">服务器</g) || []).length, 3,
  '下载中心必须明确标注服务器应用文件');
