...
COPY server ./server
COPY public ./public
COPY dist/SyncWatch-Android-v2.3.3-universal.apk ./mobile/SyncWatch同步观影-v2.3.3.apk
COPY dist/SyncWatch-Experience-Client-Portable-v2.3.3-x64.exe ./client/SyncWatch同步观影-Client-v2.3.3.exe
