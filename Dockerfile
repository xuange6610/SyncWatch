...
COPY server ./server
COPY public ./public
COPY dist/SyncWatch-Android-v2.3.7-universal.apk ./mobile/SyncWatch同步观影-v2.3.7.apk
COPY dist/SyncWatch-Experience-Client-Portable-v2.3.7-x64.exe ./client/SyncWatch同步观影-Client-v2.3.7.exe
