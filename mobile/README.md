...
This is the Android client and phone-hosted server for SyncWatch同步观影 v2.2.4. The APK
...
The verified artifact is written to `SyncWatch同步观影-v2.2.4.apk`.
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\android-package.ps1 -ApkPath .\dist\SyncWatch-Android-v2.2.4-universal.apk
```
