...
当前工作分支为 `release/v2.3.0`，源码版本为 `v2.3.0`；同版本纠正覆盖已由原子运行 `33405585536` 完成，共享性能、音源状态、主题回执和桌面启动重试已进入新的 8 项维护者资产。被替换的 v2.3.0 旧资产仅在新集合远端回读成功后删除；历史 Release、历史 Tag 和历史资产保持不变。
