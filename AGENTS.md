...
- 当前最新正式版本为 `v2.2.9`；该版本已完成最终 Tag、Actions run `33294235283`、8 个维护者资产、2 个 GitHub 源码归档、Latest 和远端哈希核对。v2.2.8 及更早版本的历史交付问题仅作复盘记录，不得覆盖当前状态。
...
- v2.2.9 Release 当前为公开 Latest，维护者资产严格 8 项；注释 Tag `v2.2.9` 指向最终构建提交 `fa577838c4ec50d28e61e66765c9ab4260ad8322`。Actions run `33294235283` 已完成 10 文件审计、远端哈希回读和 Windows/Android 启动验证。
