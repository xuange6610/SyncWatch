...
if ([string]$manifest.version -ne '2.3.2') { throw 'package.json version must be 2.3.2.' }
...
Write-Host 'Windows and Android v2.3.2 build assets are ready in root dist/.' -ForegroundColor Green
