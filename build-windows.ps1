...
if ([string]$manifest.version -ne '2.3.0') { throw 'package.json version must be 2.3.0.' }
...
Write-Host 'Windows and Android v2.3.0 build assets are ready in root dist/.' -ForegroundColor Green
